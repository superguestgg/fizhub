...
path('subject/<int:subject_number>/tickets/', views.show_all_tickets_from_subject, name='show_all_ticket'),
path('subject/<int:subject_number>/tickets/<str:sort_type>/', views.show_tickets_from_subject, name='show_ticket'),
path('subject/<int:subject_number>/tickets/<str:sort_type>/page/<int:page_number>/', views.show_tickets_from_subject_page, name='show_ticket_page'),
path('subject/<int:subject_number>/theorems/', views.show_all_theorems_from_subject, name='show_all_theorem'),
path('subject/<int:subject_number>/theorems/<str:sort_type>/', views.show_theorems_from_subject, name='show_theorem'),
path('subject/<int:subject_number>/theorems/<str:sort_type>/page/<int:page_number>/', views.show_theorems_from_subject_page, name='show_theorem_page'),
path('subject/<int:subject_number>/definitions/', views.show_all_definitions_from_subject, name='show_all_definition'),
path('subject/<int:subject_number>/definitions/<str:sort_type>/', views.show_definitions_from_subject, name='show_definition'),
path('subject/<int:subject_number>/definitions/<str:sort_type>/page/<int:page_number>/', views.show_definitions_from_subject_page, name='show_definition_page'),
...
path('university/<int:university_number>/tickets/', views.show_all_tickets_from_university, name='show_all_ticket'),
path('university/<int:university_number>/tickets/<str:sort_type>/', views.show_tickets_from_university, name='show_ticket'),
path('university/<int:university_number>/tickets/<str:sort_type>/page/<int:page_number>/', views.show_tickets_from_university_page, name='show_ticket_page'),
path('university/<int:university_number>/sessions/', views.show_all_sessions_from_university, name='show_all_session'),
path('university/<int:university_number>/sessions/<str:sort_type>/', views.show_sessions_from_university, name='show_session'),
path('university/<int:university_number>/sessions/<str:sort_type>/page/<int:page_number>/', views.show_sessions_from_university_page, name='show_session_page'),
